...
class GameBoardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final size = boardSize ?? MediaQuery.of(context).size.width * 0.9;
                  ...
                  children: [
                    ...
                    if (stone != null)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: stone == PlayerType.black
                              ? Colors.black
                              : Colors.white,
                          border: Border.all(
                            color: stone == PlayerType.white
                                ? Colors.black54
                                : Colors.transparent,
                            width: 1,
                          ),
...
class BoardLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tileSize = size.width / GameState.boardSize;
